...
class CheckFBR extends StatefulWidget {
  const CheckFBR({super.key});

  @override
  State<CheckFBR> createState() => _CheckFBRState();
}

class _CheckFBRState extends State<CheckFBR> {
  @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("FBR",style: TextStyle(fontSize: 30,color: Colors.white),),
        leading:IconButton(
          onPressed: ()
          {
      ...
      body:Container(
        ...
        child: Column(
          children: [
            SizedBox(height: 20,),
            _makeContainer('https://e.fbr.gov.pk/esbn/Service.aspx?PID=lmPn/LtGhNykqPqtHCLZzg==', 'NTN Inquiry','Asset/Images/FBR.jpg',Colors.blue),
            SizedBox(height: 20,),
